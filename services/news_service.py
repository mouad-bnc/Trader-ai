...
class NewsService:
    ...
    def _rss_fallback(self, query: str) -> list[NewsArticle]:
        return [NewsArticle(title="Actualités indisponibles", source="Trader AI", description=f"Impossible de charger les fournisseurs pour {query}. Réessayez plus tard.", ai_summary="Les marchés restent consultables et l'application continue de fonctionner hors ligne.")]
